...
/**
 * Classe permettant l'affiche en cercle du centre de table
...
public class CircleLayoutDemo {
  ...
  public static void main(String a[]) {
    ...
    Iterator<Croyant> it = Partie.centreDeTable.getCroyantsCentre().iterator();
    while (it.hasNext()) {
    	circle.add(new VueCarte(it.next()));
